...
create table cliente (id_cliente number, nombre varchar, direccion varchar, nit varchar, telefono varchar, email varchar, id_municipio number, consultas number,primary key (id_cliente),  foreign key (id_municipio) references municipio(id_municipio));
